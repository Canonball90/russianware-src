...
public class BlockInteractionHelper
{
    ...
    public static boolean isInterceptedByOther(final BlockPos originalPos) {
        return false;
    }
    
    public static void placeBlock(final BlockPos originalPos, final boolean value, final boolean b, final boolean b1, final boolean b2, final boolean b3) {
    }
